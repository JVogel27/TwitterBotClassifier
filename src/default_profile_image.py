...
#Takes a user ID string and returns a boolean of whether they have altered profile image
#I think this is broken or something
def default_profile_image(user_id):     
